...
//			System.out.println(d);
		...
		setFitnessLandscape(); // sets the fitness landscape and sets max fitness level
                        ...
                        //System.out.println("maxFitness is "+landscapeMaxFitness+ "  minFitness is "+landscapeMinFitness);
	}
...
//			System.out.println(i + ":" + s);
			double d = getFitnessContribution(s, i);
                        //System.out.println("       the string "+s+" at location "+i+" has a fitness contribution of "+d);
			fitness += d;
		}
        ...
        public double getFitness(Location l, int period, int siteNum) {
            double fitness = 0d;
            //System.out.println("getFitness period is "+period +"    Globals.temporalType is "+Globals.temporalType);
            if(Globals.temporalType == 0){
                //System.out.println("no temp diff both sites");
		for (int i = 0; i < Globals.N; i++) {
			String s = l.getLocationAt(i, im);
//			System.out.println(i + "," + K + ":" + s);
//			System.out.println(i + ":" + s);
            ...
            }else if(Globals.temporalType==1){
               // System.out.println("no overlap");
                if((period%4==0||period%4==1)&&siteNum==0){
                   // System.out.println("no overlap, site 0");
...
//			System.out.println(i + "," + K + ":" + s);
//			System.out.println(i + ":" + s);
			double d = Globals.weight*getFitnessContribution(s, i);
                       // System.out.println("       the string "+s+" at location "+i+" has a fitness weighted contribution of "+d);
			fitness += d;
		    }
                }else{
                  //  System.out.println("no overlap, site 1");
                    for (int i = 0; i < Globals.N/2; i++) {
			String s = l.getLocationAt(i, im);
			double d = Globals.weight*getFitnessContribution(s, i);
                       // System.out.println("       the string "+s+" at location "+i+" has a weighted fitness contribution of "+d);
			fitness += d;
		    }
                    for (int i = Globals.N/2; i < Globals.N; i++) {
			String s = l.getLocationAt(i, im);
...
//			System.out.println(i + ":" + s);
			...
			fitness += d;
                ...
                if(period%4==0&&siteNum==0){
                    // System.out.println("some overlap, site 0");
                    for (int i = 0; i < Globals.N/2; i++) {
			String s = l.getLocationAt(i, im);
//			System.out.println(i + "," + K + ":" + s);
//			System.out.println(i + ":" + s);
...
//			System.out.println(i + ":" + s);
			...
			fitness += d;
                       ...
                       // System.out.println("some overlap, both sites");
                    for (int i = 0; i < Globals.N; i++) {
			String s = l.getLocationAt(i, im);
//			System.out.println(i + "," + K + ":" + s);
//			System.out.println(i + ":" + s);
			...
			fitness += d;
                ...
                }else if(period%4==2&&siteNum==1){
                    
                       // System.out.println("some overlap, site 1");
                    for (int i = 0; i < Globals.N/2; i++) {
			String s = l.getLocationAt(i, im);
			double d = Globals.weight*getFitnessContribution(s, i);
                      //  System.out.println("       the string "+s+" at location "+i+" has a weighted fitness contribution of "+d);
...
///                             System.out.println("update min "+minFitness);
     ...
     */
	private double getFitnessContribution(String locationString, int place) {  //place means the id of each cluster 
